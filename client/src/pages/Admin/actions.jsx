...
const AdminActions = () => {
  ...
  useEffect(() => {
    axios.get('http://opinionlk.azurewebsites.net:3002/api/auth/getmembers').then(response => {
  ...
  const handleSubmit = async event => {
    ...
    try {
      await axios.post('http://opinionlk.azurewebsites.net:3002/api/auth/savemember', {
        ManagerFirstName,
        ManagerLastName,
        ManagerDistrict,
        ManagerAddLine1,
